...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Fuse HVAC";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Fuse HVAC, Refrigeration, Electrical & Plumbing";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Fuse HVAC, Refrigeration, Electrical & Plumbing";          // e.g. "AirPro Heating & Air Conditioning, Inc."
...
export const BRAND_INITIALS   = "FHR";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 380-2669";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14083802669";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "accounting@fuseservice.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "2512 Seaboard Ave, San Jose, CA 95131";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"

// ─── Social Proof ─────────────────────────────────────────────────────────────
export const GOOGLE_RATING  = "4.9";   // e.g. "5.0"
export const GOOGLE_REVIEWS = "1012";  // e.g. "47"
...
export const SEO_TITLE       = "Fuse HVAC, Refrigeration, Electrical & Plumbing — San Jose HVAC";
export const SEO_DESCRIPTION = "Fuse HVAC, Refrigeration, Electrical & Plumbing — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 380-2669";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Fuse HVAC, Refrigeration, Electrical & Plumbing technician servicing a residential HVAC system in San Jose";
...
export const TESTIMONIALS = [
  ...
  {
    quote: "I've used several HVAC companies over the years, but Fuse HVAC is by far the best. New system installed, whole process was smooth from start to finish. Clean work, fair price.",
    author: "Jennifer L.",
    role: "Google Review · 5★",
  },
  {
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Fuse HVAC, Refrigeration, Electrical & Plumbing has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Fuse HVAC, Refrigeration, Electrical & Plumbing is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
